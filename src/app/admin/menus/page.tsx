...
const MenuNameEditor = ({
  ...
  return (
    <input
      type="text"
      className="w-full border-line-strong rounded-md text-sm px-2 py-1 focus:ring-primary focus:border-primary font-bold text-gray-700"
      value={value}
      ...
      <div className="bg-white rounded-md shadow-sm border border-line overflow-hidden">
        ...
        <div className="overflow-x-auto">
          <table className={`${table} min-w-full`}>
            <thead>
              <tr>
                <th className={`${thWide} text-left font-bold w-20`}>
                  순서
                </th>
                <th className={`${thWide} text-left font-bold w-56`}>
                  메뉴 이름
                </th>
                  ...
                  <td className={`${tdWide} whitespace-nowrap`}>
                    <div className="flex flex-col gap-0.5">
                      <button
                        ...
                        disabled={index === 0}
                        className="p-1 rounded text-gray-400 hover:text-primary hover:bg-primary-wash transition disabled:opacity-20 disabled:cursor-not-allowed"
                        title="위로"
                      >
                    ...
                    <div className="flex gap-4 flex-wrap">
                      {ALL_ROLES.map((role) => (
                        ...
                        >
                          <input
                            type="checkbox"
                            className="rounded border-line-strong text-primary focus:ring-primary w-4 h-4 cursor-pointer"
