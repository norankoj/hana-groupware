...
const FALLBACK_VERSES = [
  ...
  {
    text: "내가 능히 나를 강하게 하시는 자 안에서 모든 것을 할 수 있느니라",
    ref: "빌립보서 4:13",
  },
  {
  ...
  {
    text: "예수는 어제나 오늘이나 영원토록 동일하시니라",
    ref: "히브리서 13:8",
  },
  {
    text: "믿음의 주요 또 온전하게 하시는 이인 예수를 바라보자",
    ref: "히브리서 12:2",
  },
  {
    text: "그러므로 누구든지 그리스도 안에 있으면 새로운 피조물이라",
    ref: "고린도후서 5:17",
  },
  {
    text: "이제 믿음, 소망, 사랑, 이 세 가지는 항상 있을 것인데 그 중의 제일은 사랑이라",
    ref: "고린도전서 13:13",
  },
  {
