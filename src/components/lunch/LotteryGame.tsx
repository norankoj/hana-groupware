    ...
    <div className="flex flex-col items-center gap-6">
      {!started ? (
        ...
        <>
          ...
          <div className={`grid gap-3 w-full ${n <= 4 ? "grid-cols-2 sm:grid-cols-4" : "grid-cols-3 sm:grid-cols-4"}`}>
            {names.map((name, i) => {
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <span className="text-xs font-bold opacity-90">{name.length > 5 ? name.slice(0, 5) + "…" : name}</span>
                    </div>
                    ...
                    >
                      <span className="text-2xl mb-1">{isWinner ? "🎉" : "😢"}</span>
